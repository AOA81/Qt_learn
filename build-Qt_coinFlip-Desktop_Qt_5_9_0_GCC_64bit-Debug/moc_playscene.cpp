...
#include "../Qt_coinFlip/playscene.h"
...
QT_MOC_LITERAL(1, 10, 15), // "chooseSenceBack"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "PlayScene\0chooseSenceBack\0"
};
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayScene::chooseSenceBack)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayScene::chooseSenceBack()
{
